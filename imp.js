  ...
  try {
    ...
    const resp = await fetch(
      "https://ping.arya.ai/api/v1/signature-detection",
      {
        method: "POST",
        headers: {
          token: "c97cf7cdf3376bc7a978b2b41f80ad4d",
          "content-type": "application/json",
        },
        body: JSON.stringify({ output_format, doc_base64, req_id }),
      }
